...
RUN cd /home/caboose \  
    && curl -L -O https://github.com/dictyBase/Chado-Sqitch/releases/download/dictychado-1.23.7/sqitch-dictychado-1.23.7.tar.gz \
    && tar xvzf sqitch-dictychado-1.23.7.tar.gz \
    && chown -R caboose /home/caboose 


# Source code folder will be the default landing spot
WORKDIR /home/caboose/sqitch-dictychado-1.23.7
